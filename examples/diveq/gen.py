...
if __name__ == "__main__":
    ...
    example_sets['LLM'].liveout = ['a']

    # Set up any important sub-fields in any of the tests.
    # Need to set an example program for simpl.
    example_sets['simpl'].partial_program = """
fun arr, len, otherarray, otherlen ->
n = 0;
while(?) {
?;
}
...
"""
    ...
    example_sets['simpl'].int_var_comps = 'n,len,otherlen'
    example_sets['simpl'].array_var_comps = 'arr,otherarray'
